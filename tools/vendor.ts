...
const TRANSCRIPTION_SOURCE_PATHS = [
  ...
  "src/Corporation/data/CorporationUnlocks.ts",
  "src/Corporation/data/IndustryData.ts",
  "src/Corporation/helpers.ts",
...
await extractDataTable({
  ...
  shape: `(() => {
    ...
    return Object.fromEntries(serverMetadata.map((s) => [s.hostname, {
      ...
      ...(s.specialName === undefined ? {} : { specialName: s.specialName }),
