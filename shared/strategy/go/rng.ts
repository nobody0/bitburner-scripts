...
/** WHRNG seeds are converted to seconds and reduced modulo 30,000. Keeping
 * worker protocol seeds in this range makes clock confirmation independent of
 * the player's absolute lifetime. */
