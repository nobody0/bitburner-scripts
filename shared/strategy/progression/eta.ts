...
/** What every feature reads as "expected remaining run time" when no route
 * decision has been published yet — the pre-existing behaviour of the
 * hard-coded literals it replaces. */
 ...
 * decision into "do nothing", and a multi-day one adds nothing over a day. */
