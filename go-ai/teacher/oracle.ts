...
import type { GoBoard } from "./strategy/decide.ts";
import type { AsyncGoPolicy } from "../../sim/features/go.ts";
...
import { simpleBoardFromBoard } from "../../sim/vendor/bitburner/src/Go/boardAnalysis/boardAnalysis.ts";
import {
  getNewBoardState,
  getNewBoardStateFromSimpleBoard,
} from "../../sim/vendor/bitburner/src/Go/boardState/boardState.ts";
import { Go, Player } from "../../sim/vendor/bitburner/src/Go/OracleStubs.ts";
