// Vendored from bitburner-src v3.0.1:src/BitNode/BitNodeMultipliers.ts by tools/vendor.ts — DO NOT EDIT
import { getRecordEntries, type PartialRecord } from "../Types/Record";
