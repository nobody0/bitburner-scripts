// Vendored from bitburner-src v3.0.1:src/StockMarket/Stock.ts by tools/vendor.ts — DO NOT EDIT
...
import { getRandomIntInclusive, stockRandom } from "./MarketAdapter";
