// Vendored from bitburner-src v3.0.1:src/Go/boardState/boardState.ts by tools/vendor.ts — DO NOT EDIT
import type { Board, BoardState, Move, Neighbor, PointState, SimpleBoard } from "../Types";
...
import { endGoGame } from "../OracleStubs";
