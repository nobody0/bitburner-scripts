// Vendored from bitburner-src v3.0.1:src/Go/boardAnalysis/boardAnalysis.ts by tools/vendor.ts — DO NOT EDIT
...
import { getEmptyHighlightedPoints, Go, GoEvents } from "../OracleStubs";
import {
...
export function clearAllPointHighlights(board: BoardState) {
  board.highlightedPoints = getEmptyHighlightedPoints(board.board.length);
  GoEvents.emit();
}
