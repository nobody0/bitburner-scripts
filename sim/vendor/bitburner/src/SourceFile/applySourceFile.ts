// Vendored from bitburner-src v3.0.1:src/SourceFile/applySourceFile.ts by tools/vendor.ts — DO NOT EDIT
const SourceFiles: Record<string, true> = Object.fromEntries(Array.from({ length: 15 }, (_, i) => ["SourceFile" + (i + 1), true]));

import { Player } from "./SourceFileAdapter";
